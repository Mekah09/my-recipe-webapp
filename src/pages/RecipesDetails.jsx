        ...
        <div className="flex flex-wrap m-5">
          ...
          <div className="mt-2">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-md text-gray-800 text-xs font-semibold border border-black">
                {findRecipesDetails?.cuisine} Cuisine
              </span>
              <span className="px-2.5 py-0.5 rounded-md text-gray-800 text-xs font-medium border border-gray-500">
                {findRecipesDetails?.difficulty}
              </span>
              <div className="flex items-center gap-1 text-xs text-gray-800 ml-auto">
                ...
                <span className="text-gray-500 text-[11px]">({findRecipesDetails?.reviewCount} reviews)</span>
              </div></div>
