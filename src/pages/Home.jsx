    ...
    <div className="min-h-screen w-full bg-milk text-charcoal">
      ...
      <section className="relative py-12 lg:py-18 overflow-hidden bg-oat">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            <div data-aos="fade-right" className="lg:col-span-6 space-y-6 text-center lg:text-left">
      ...
      <section className="py-14 border-t border-white/5 bg-mocha">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div data-aos="fade-up" className="text-center max-w-xl mx-auto mb-10 space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div data-aos="fade-up" data-aos-delay="0" className="bg-charcoal p-6 rounded-2xl border border-milk/10 space-y-2.5">
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="bg-charcoal p-6 rounded-2xl border border-milk/10 space-y-2.5">
              <div className="w-7 h-7 rounded-lg bg-mocha flex items-center justify-center text-xs font-bold text-milk">
                02
              </div>
              <h3 className="font-display font-bold text-base text-milk">
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="bg-charcoal p-6 rounded-2xl border border-milk/10 space-y-2.5">
              <div className="w-7 h-7 rounded-lg bg-mocha flex items-center justify-center text-xs font-bold text-milk">
                03
              </div>
              <h3 className="font-display font-bold text-base text-milk">
      ...
      <section className="py-16 border-t border-milk/5 bg-oat text-center">
        <div data-aos="zoom-in" className="max-w-3xl mx-auto px-4 space-y-5">
