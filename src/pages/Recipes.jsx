      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 m-4">
          {recipes.map((recipe) => {
            ...
            return (
              <div key={recipe.id} className="overflow-hidden rounded-2xl bg-milk border border-oat shadow-md p-3.5 flex flex-col justify-between cursor-pointer transition hover:scale-105 hover:shadow-lg">
                  ...
                  <div className="relative aspect-4/3 rounded-xl overflow-hidden mb-3 ">
                    ...
                    />
                    <span className="absolute top-2.5 left-2.5 bg-black/75 backdrop-blur-md text-milk text-[10px] font-bold px-2 py-0.5 rounded-md border border-white/10">
                      {recipe.cuisine}
                    </span>
                    ...
                    <div className="absolute bottom-2.5 right-2.5 bg-black/75 backdrop-blur-md text-oat text-[10px] font-semibold px-2 py-0.5 rounded-md border border-white/10">
                      {recipe.difficulty}
                    </div>
                  </div>
                  ...
                  <div className="mt-4 flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <h3 className="text-xl font-bold text-charcoal">{recipe.name}</h3>
                    ...
                    <div className="mt-2 flex items-center justify-end gap-2">
                      <button className="rounded-full border border-mocha px-3 py-1 text-xs font-medium text-slate-700 transition hover:bg-slate-100">
                        {recipe.tags[0]}
                      </button>
                      <button className="rounded-full border border-mocha px-3 py-1 text-xs font-medium text-slate-700 transition hover:bg-slate-100">
                        {recipe.tags[1]}
